...
?>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td rowspan="3"><img src="<?php echo "img\\".$book["id_livres"]?>.jpg"/></td><!-- Cette ligne dit que j'affiche toutes les images qui provienne de la fonction findAllBooks -->
			...
			<tr>
				<td><b><?php echo $book["prix"] ?>�</b>&nbsp<a href="index.php?action=addToCart&id=<?php echo $book["id_livres"] ?>">Ajouter au panier</a></td> <!-- Affiche en gras le prix  et ajoute
