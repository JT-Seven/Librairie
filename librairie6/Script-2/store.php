...
?>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td rowspan="3"><img class="images" src="<?php echo "img\\".$book["id_produit"]?>.jpg"/></td><!-- Cette ligne dit que j'affiche toutes les images qui provienne de la fonction findAllprod -->
				<td><h2 style="margin: 0px;padding:0px"><?php echo strtoupper($book["titre"]) ?></h2></td> <!-- Cette ligne affiche tout les tritres 
				provenant de la fonction finAllprod en majuscules-->
			</tr>
			<tr>
				<td><p><?php echo $book["description"] ?></p></td><!-- Affiche la description via la fonction findAllprod -->
			</tr>
			<tr>
				...
				un lien qui redirige vers le fichier 'inconstruction.php' mais sous le nom de 'addtocart' + son id personnel ajouter via la fonction findAllprod -->
			</tr>
		</table>
		<hr />		
<?php
